<template>
  <div>
    <div class="p-4">
      <h1
        class="font-bold text-xl text-white mb-10 tablet:text-2xl text-center"
      >
        This experience is best viewed on larger screens
      </h1>
      <div
    ...
    <div>
      <h1
        class="font-bold text-md text-white mb-10 tablet:text-lg text-center"
      >
        Headphones recommended for best experience. Use the WASD keys to manuever and the mouse to look around.
      </h1>
    </div>
  </div>
</template>
